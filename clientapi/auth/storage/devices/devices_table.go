...
CREATE TABLE IF NOT EXISTS device_devices (
    ...
    -- The user ID localpart for this device. This is preferable to storing the full user_id
...
func (s *devicesStatements) prepare(db *sql.DB, server string) (err error) {
